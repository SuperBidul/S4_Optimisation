...
/**
 * classe destinee a afficher une fonction
 */
...
public class Affichage{
    ...
    /**
     * set ymin et ymax automatique a partir d'une fonction.
     * La fonction est entièrement affichee entre xmin et xmax
     *
     *@param f la fonction a utiliser pour determiner l'echelle
     */
    public void setYMinMax(Fonction1D f){
        ...
        // recherche min et max de la valeur de la fonction
        for (int i=0;i<tailleX;i++){
    ...
    public void dessinerPoint(double x, double y){
        ...
        // 3. dessiner un cercle de rayon 2 (g.drawOval(x,y,2,2))
        //##############################
    ...
    */
    ...
    /**
     * Permet de modifier l'intervale sur X (echelle) pour l'affichage
     *
    ...
    /**
     * permet de modifier l'intervale sur Y (echelle verticale) pour l'affichage
     *
