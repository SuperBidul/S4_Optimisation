...
import tp3.encadrement.Encadrement;
import tp3.fonction.utile.Derivee;
import tp3.fonction.cercle.FonctionRayon;
import tp3.fonction.cercle.FonctionX;
import tp3.fonction.cercle.FonctionY;
...
public class MainCercle {
    public static void main(String[] args) {
        ...
        System.out.printf("Meilleur tp3.cercle trouvé -> x: %.4f, y: %.4f, r: %.4f\n", x, y, r);
    }
}
